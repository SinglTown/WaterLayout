...
//    CGFloat itemWidth = self.collectionView.frame.size.width-45;
//    self.itemSize = CGSizeMake(itemWidth, itemWH);
//    
//    // 设置内边距
//    CGFloat inset = (self.collectionView.frame.size.width - itemWidth) /4;
